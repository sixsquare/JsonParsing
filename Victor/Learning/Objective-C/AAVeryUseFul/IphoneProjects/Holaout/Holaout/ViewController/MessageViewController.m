...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [NSTimer scheduledTimerWithTimeInterval:30 target:[QBChat instance] selector:@selector(sendPresence)
...
- (void)keyboardWillShow:(NSNotification *)note
{
    ...
    {
        [UIView animateWithDuration:0.3 animations:^{
            [self.messageTextField setFrame:CGRectMake(self.messageTextField.frame.origin.x, self.messageTextField.frame.origin.y-315,self.messageTextField.frame.size.width,self.messageTextField.frame.size.height)];
            [self.btnAdd setFrame:CGRectMake(self.btnAdd.frame.origin.x, self.btnAdd.frame.origin.y-315,self.btnAdd.frame.size.width,self.btnAdd.frame.size.height)];
            [self.btnSend setFrame:CGRectMake(self.btnSend.frame.origin.x, self.btnSend.frame.origin.y-315,self.btnSend.frame.size.width,self.btnSend.frame.size.height)];
            [self.lblDestruct setFrame:CGRectMake(self.lblDestruct.frame.origin.x, self.lblDestruct.frame.origin.y-315,self.lblDestruct.frame.size.width,self.lblDestruct.frame.size.height)];
            [self.btnDestruct setFrame:CGRectMake(self.btnDestruct.frame.origin.x, self.btnDestruct.frame.origin.y-315,self.btnDestruct.frame.size.width,self.btnDestruct.frame.size.height)];
            [self.messageTableView setFrame:CGRectMake(self.messageTableView.frame.origin.x,self.messageTableView.frame.origin.y,self.messageTableView.frame.size.width, self.messageTableView.frame.size.height-315)];
//            [self.btnPlus setFrame:CGRectMake(self.btnPlus.frame.origin.x, self.btnPlus.frame.origin.y-315,self.btnPlus.frame.size.width,self.btnPlus.frame.size.height)];
            if(self.messages.count > 0){
                NSLog(@"%d",self.messages.count);
                [self.messageTableView scrollToRowAtIndexPath:[NSIndexPath indexPathForRow:[self.messages count]-1 inSection:0] atScrollPosition:UITableViewScrollPositionBottom animated:YES];
            }
...
- (void)keyboardWillHide:(NSNotification *)note
{
    ...
    else
    {
        [UIView animateWithDuration:0.3 animations:^{
            ...
            [self.btnDestruct setFrame:CGRectMake(self.btnDestruct.frame.origin.x, self.btnDestruct.frame.origin.y+315,self.btnDestruct.frame.size.width,self.btnDestruct.frame.size.height)];
            [self.messageTableView setFrame:CGRectMake(self.messageTableView.frame.origin.x,self.messageTableView.frame.origin.y,self.messageTableView.frame.size.width, self.messageTableView.frame.size.height+315)];
//            [self.btnPlus setFrame:CGRectMake(self.btnPlus.frame.origin.x, self.btnPlus.frame.origin.y+215,self.btnPlus.frame.size.width,self.btnPlus.frame.size.height)];
            if(self.messages.count > 0){
                [self.messageTableView scrollToRowAtIndexPath:[NSIndexPath indexPathForRow:[self.messages count]-1 inSection:0] atScrollPosition:UITableViewScrollPositionBottom animated:YES];
            }
        }];
